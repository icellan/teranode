...
// package p2p_api.v1 (or the next version) at that time -- not before.
...
func (c *peerServiceClient) ReportValidatedChainProgress(ctx context.Context, in *ReportValidatedChainProgressRequest, opts ...grpc.CallOption) (*ReportValidatedChainProgressResponse, error) {
	...
	err := c.cc.Invoke(ctx, PeerService_ReportValidatedChainProgress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PeerService_ReportValidatedChainProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(PeerServiceServer).ReportValidatedChainProgress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PeerService_ReportValidatedChainProgress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerServiceServer).ReportValidatedChainProgress(ctx, req.(*ReportValidatedChainProgressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PeerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PeerService_ReportValidatedChainProgress_Handler,
		},
		{
