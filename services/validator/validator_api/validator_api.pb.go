...
// package has already had a breaking change handled via a `reserved` field
// without a version bump (see ValidateTransactionRequest field 10 below) --
// reserving prevents wire corruption but is not the same as version
// coexistence. A version bump (v2) is for changes reserved fields can't
